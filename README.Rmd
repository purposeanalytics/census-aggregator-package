...
The goal of censusaggregate is to easily retrieve and aggregate Canadian census variables, and their breakdowns, across multiple (shared) geographies.
